...
$configsetup = [
    ...
    'pictures' => [
        ...
        'picture_qrSize' => [
            'view' => 'advanced',
            'type' => 'range',
            'placeholder' => $defaultConfig['picture']['qrSize'],
            'name' => 'picture[qrSize]',
            'value' => $config['picture']['qrSize'],
            'range_min' => 4,
            'range_max' => 10,
            'range_step' => 2,
            'unit' => 'empty',
        ...
        'picture_qrPosition' => [
            'view' => 'advanced',
            'type' => 'select',
            'name' => 'picture[qrPosition]',
            'placeholder' => $defaultConfig['picture']['qrPosition'],
            'options' => [
                'topLeft' => 'top left',
                'top' => 'top',
                'topRight' => 'top right',
            ...
            'value' => $config['picture']['qrPosition'],
        ],
        'picture_qrOffset' => [
            'view' => 'expert',
            'type' => 'number',
            'placeholder' => $defaultConfig['picture']['qrOffset'],
            'name' => 'picture[qrOffset]',
            'value' => $config['picture']['qrOffset'],
        ],
        'picture_qrMargin' => [
            'view' => 'advanced',
            'type' => 'range',
            'placeholder' => $defaultConfig['picture']['qrMargin'],
            'name' => 'picture[qrMargin]',
            'value' => $config['picture']['qrMargin'],
            'range_min' => 0,
            'range_max' => 10,
            'range_step' => 1,
            'unit' => 'empty',
        ...
        'picture_qrBgColor' => [
            'view' => 'expert',
            'type' => 'color',
            'name' => 'picture[qrBgColor]',
            'placeholder' => $defaultConfig['picture']['qrBgColor'],
            'value' => $config['picture']['qrBgColor'],
        ],
